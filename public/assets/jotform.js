...
JotForm.init(function () {
  /*INIT-START*/
  if (typeof $("input_6").spinner !== "undefined") {
    $("input_6").spinner({
...
var all_spc = document.querySelectorAll(
  "form[id='231768221965059'] .si" + "mple" + "_spc"
);
